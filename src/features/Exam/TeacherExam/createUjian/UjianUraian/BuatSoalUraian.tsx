...
import useCreateQuestion from '../../components/ExamTabComponent/BuatSoalSendiri/useCreateQuestion';
...
const SecondRoute: React.FC = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    createSoalSendiri(
      ...
      //  navigation.pop();
      //  navigation.replace('SecondRoute', {
      //    package_id,
      //    subject_id,
      //   //  title,
      //    class_id,
                      ...
                      return (
                        <>
                          <HtmlEditorTextArea
                            ...
                            value={value}
                            errorLabel={
                              errors?.discussion?.explanation?.message
                            }
                          />

                          <SoundPlayer source={field.file_id as string} />
